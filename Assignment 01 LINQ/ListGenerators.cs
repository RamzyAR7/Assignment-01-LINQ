...
namespace Assignment_01_LINQ
{
    ...
    internal static class ListGenerators
    {
        ...
        // important to note that static constructor is called only once
        // when you using static class, you can use static constructor that assigns values to the static properties
        // like using static namespace.classname and use the properties directly
        // this will call the static constructor and assign values to the static properties
